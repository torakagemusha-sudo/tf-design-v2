...
export interface DataGridFilterPanelProps extends TorafirmaComponentBaseProps {
  filters: TableFilter[];
...
const DataGridFilterPanel: React.FC<DataGridFilterPanelProps> = ({
  ...
  return (
    <div id={id} data-testid={testId} data-state={state} data-trace-id={traceId} className={`tf-data-grid-filter-panel tf-data-grid-filter-panel--density-${density}`}>
      <FilterBar
        filters={filters}
        columns={columns}
        density={density}
...
DataGridFilterPanel.displayName = 'DataGridFilterPanel';
